...
/* harmony import */ var _modules_masks__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/masks */ "./src/js/modules/masks.js");
...
window.addEventListener('DOMContentLoaded', function () {
  'use strict', Object(_modules_modals__WEBPACK_IMPORTED_MODULE_0__["default"])();
  ...
  Object(_modules_masks__WEBPACK_IMPORTED_MODULE_3__["default"])('[name="phone"]');
...
var drop = function drop() {
  ...
  // dragleave - обїект за пределами droparea
  // dragover - объект зависает на droparea
...
var filter = function filter() {
  ...
  bntGuy.addEventListener('click', function () {
    typeFilter(markGuy);
  });
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      statusImg.classList.add('animaited', 'fadeInUp');
